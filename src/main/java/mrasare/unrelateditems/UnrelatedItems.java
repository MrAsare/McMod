...
@Mod(UnrelatedItems.MODID)

public class UnrelatedItems {
        ...
        public static final String MODID = "unrelateditems";

        public UnrelatedItems() {
        ...
        public void registerCommonEvents(IEventBus eventBus) {
            eventBus.register(mrasare.unrelateditems.blocks.blockslippy.StartupCommon.class);
